...
public class Grid 
{
    ...
    public void AddToValue(int x, int y, int value)
    {
    ...
    public void AddToValue(Vector3 worldPosition, int value)
    {
        int x, y;
        GetXY(worldPosition, out x, out y);
        AddToValue(x, y, value);
    }
    ...
    public int GetValue(int x, int y)
    {
        ...
        {
            Debug.LogWarning("trying to get out of range value");
            return -1;
        }
    }
